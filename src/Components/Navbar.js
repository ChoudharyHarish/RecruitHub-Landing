    ...
    >
      <div className="flex md:w-auto w-full md:justify-between items-center relative px-4">
        <div className="flex justify-center">
          <h1 className="text-primary text-3xl" style={{ fontWeight: 500 }}>
      ...
      <div className="md:hidden flex mt-4 lg:mt-0">
          <button className="text-primary mx-4 font-bold md:hidden block">Sign In</button>
          <button className="bg-primary text-white py-3  px-4 md:hidden block rounded-xl font-bold btn">
            Get Started
          </button>
          </div>
        </div>
        ...
        <div
          ...
          onClick={handleClick}
        >
          <span className="bg-primary my-0.5 line"></span>
          <span className="bg-primary my-0.5 line"></span>
          <span className="bg-primary my-0.5 line"></span>
        </div>
      </div>

      <div className="hidden md:flex mt-4 lg:mt-0">
        <button className="text-white mx-4 font-bold">Sign In</button>
        <button className="bg-primary text-white py-3 px-4 rounded-xl font-bold btn">
          Get Started
        </button>
      </div>
    </div>
